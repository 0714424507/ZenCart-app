    ...
    <div>
      ...
      <div className="product-details">
        ...
        <div className="info-details">
          ...
          <div>
            <FacebookShareButton url={currentUrl} hashtag={'#zencart'}>
              <FacebookIcon size={32} round />
            </FacebookShareButton>
            <PinterestShareButton url={currentUrl} hashtag={'#zencart'}>
              <PinterestIcon size={32} round />
            </PinterestShareButton>
            <TwitterShareButton url={currentUrl} hashtag={'#zencart'}>
